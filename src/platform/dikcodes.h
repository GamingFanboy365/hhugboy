...
// DirectInput keyboard scan codes (DIK_*), as defined in dinput.h.
// Key bindings are stored in the config file as these codes on every
// platform, so non-Windows frontends translate their native key codes to them.

#ifndef HHUGBOY_DIKCODES_H
#define HHUGBOY_DIKCODES_H
